...
namespace 学生宿舍管理系统
{
    public partial class Repair_Book : Form
    {
        ...
        {
            string Repair_Book_connString = "server=DESKTOP-V3H7EOU\\MSSQLSERVER02;database=Stu_Doemitory; Trusted_Connection =SSPI";
            SqlConnection Repair_Book_conn = new SqlConnection(Repair_Book_connString);

            string Repair_Book_sql;
            if (Repair_Book_DorID.Text == "")
                Repair_Book_sql = "insert into repair (reporttime,rep_time,rep_reason,rep_man,rep_price,rep_fixing,rep_num)values('" + Repair_Book_BookTime.Text + "','" + Repair_Book_RepairTime.Text + "','" + Repair_Book_RepReason.Text + "','" + Repair_Book_RepMan.Text + "','" + Repair_Book_Price.Text + "','" + Repair_Book_Fixing.Text + "','" + Repair_Book_RepNum.Value.ToString() + "')";
            else Repair_Book_sql = "insert into repair(dor_ID,reporttime,rep_time,rep_reason,rep_man,rep_price,rep_fixing,rep_num)  values('" + Repair_Book_DorID.Text + "','" + Repair_Book_BookTime.Text + "','" + Repair_Book_RepairTime.Text + "','" + Repair_Book_RepReason.Text + "','" + Repair_Book_RepMan.Text + "','" + Repair_Book_Price.Text + "','" + Repair_Book_Fixing.Text + "','" + Repair_Book_RepNum.Value.ToString() + "')";
            try
            {
