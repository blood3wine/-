...
namespace 学生宿舍管理系统
{
    public partial class Std_Del : Form
    {
        ...
        {
            string Std_Del_connString = "server=DESKTOP-V3H7EOU\\MSSQLSERVER02;database=Stu_Doemitory; Trusted_Connection =SSPI";
            ...
            try
            {
                ...
                {
                    MessageBox.Show("学生信息删除成功！宿舍相应人数修改成功！", "删除成功", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
