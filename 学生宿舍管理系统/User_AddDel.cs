...
namespace 学生宿舍管理系统
{
    public partial class User_AddDel : Form
    {
        ...
        {
            string User_Add_connString = "server=DESKTOP-V3H7EOU\\MSSQLSERVER02;database=Stu_Doemitory; Trusted_Connection =SSPI";
        ...
        {
            string User_Del_connString = "server=DESKTOP-V3H7EOU\\MSSQLSERVER02;database=Stu_Doemitory; Trusted_Connection =SSPI";
        ...
        private void User_AddDel_DelUserType_SelectedIndexChanged(object sender, EventArgs e)
        {
